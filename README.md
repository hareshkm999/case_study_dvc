## Please mention your data file path in config.yaml:
C:/Users/hares/Desktop/MLOPS/Case study/dvc-ML-AIOps-main/data/Dataset.xlsx

## create conda env:
conda create -n dvc-ML-AIOps-main python=3.7 -y

## activate conda env:
conda activate dvc-ML-AIOps-main

## install requirements in bash terminal:
pip install -r requirements.txt

## run stage 1 using python command:
python src/stage_01_load_save.py 

## run stage 2 using python command:
python src/stage_02_split_data.py 

## run stage 3 using python command:
python src/stage_03_train.py
